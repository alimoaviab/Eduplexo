...
export default function App() {
  ...
  const loadDashboard = useCallback(async (authToken: string) => {
    ...
    try {
      ...
      setLoginError('Network error connecting to publisher server')
    } finally {
      setLoading(false)
    }
  }, [])
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50/70 p-4 font-sans">
        <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-200/80 max-w-md w-full animate-in fade-in zoom-in-95 duration-200">
          <div className="h-14 w-14 bg-gradient-to-tr from-blue-600 to-indigo-600 text-white rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-lg shadow-blue-500/25 font-black text-2xl">
            P
          </div>
          
          <div className="text-center mb-6">
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">Publisher Portal</h1>
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-xs">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 bg-blue-600 text-white rounded-xl flex items-center justify-center font-black text-base shadow-sm">
              P
            </div>
            <div>
